...
# Load the data
model_template, data = final_extinctionrisk_noth()
...
print(f"Training set size: {len(train_data)} final_extinctionrisk_noth")
print(f"Testing set size: {len(test_data)} final_extinctionrisk_noth")
...
# GUARDAR BASELINE
os.makedirs('confold_results_noth', exist_ok=True)
with open('confold_results_noth/01_baseline.txt', 'w') as f:
    baseline_model.asp()
...
with open('confold_results_noth/02_expert_with_confidence.txt', 'w') as f:
    expert_model.asp()
...
rule1_no_confidence = "class = 'Higher_risk' if 'Range_size' '<=' '75321' and 'Body_mass' '>=' '130' and 'Generation_length' '>=' '4.068' and 'Elevational_range' '<=' '800'"
rule2_no_confidence = "class = 'Higher_risk' if 'Range_size' '<=' '75321' and 'Body_mass' '>=' '130' and 'Elevational_range' '<=' '800'"
rule3_no_confidence = "class = 'Higher_risk' if 'Range_size' '<=' '75321' and 'Generation_length' '>=' '4.068' and 'Elevational_range' '<=' '800'"
rule4_no_confidence = "class = 'Higher_risk' if 'Range_size' '<=' '75321' and 'Body_mass' '>=' '130' and 'Generation_length' '>=' '4.068'"
rule5_no_confidence = "class = 'Higher_risk' if 'Body_mass' '>=' '130' and 'Generation_length' '>=' '4.068' and 'Elevational_range' '<=' '800'"
...
with open('confold_results_noth/04_simple_pruned_model_expert_confidence.txt', 'w') as f:
...
# PRUNED MODEL
with open('confold_results_noth/05_advanced_pruning_model.txt', 'w') as f:
