...
rule2 = "with confidence 0.90 class = 'Higher_risk' if 'Elevational_range' '<=' '800'"
rule3 = "with confidence 0.90 class = 'Higher_risk' if 'Generation_length' '>=' '4.068'"
rule4 = "with confidence 0.80 class = 'Higher_risk' if 'Body_mass' '>=' '130'"
...
rule2_no_confidence = "class = 'Higher_risk' if 'Elevational_range' '<=' '800'"
rule3_no_confidence = "class = 'Higher_risk' if 'Generation_length' '>=' '4.068'"
rule4_no_confidence = "class = 'Higher_risk' if 'Body_mass' '>=' '130'"
