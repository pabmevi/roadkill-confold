...
def final_extinctionrisk(data_path='datasets/Extinction/traits_finalnoNA_26Nov25.csv'):
    attrs = [#"Residential_IUCN",
             ...
             "Beak.Length_Culmen_AVONET",#"Beak.Length_Nares_AVONET",
             #"Beak.Width_AVONET",
             "Beak.Depth_AVONET",
             "Tarsus.Length_AVONET","Wing.Length_AVONET","Kipps.Distance_AVONET",#"Secondary1_AVONET",
             "Hand.Wing.Index_AVONET",
             ...
             #"Maximum.longevity_GenLength",
             "GenLength_GenLength","Foraging_BirdBehav","MatingSystem_BirdBehav",
    ...
    nums = ["Beak.Length_Culmen_AVONET",#"Beak.Length_Nares_AVONET","Beak.Width_AVONET",
            "Beak.Depth_AVONET",
             "Tarsus.Length_AVONET","Wing.Length_AVONET","Kipps.Distance_AVONET",#"Secondary1_AVONET",
             "Hand.Wing.Index_AVONET",
